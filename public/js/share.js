...
function updateVehicleOnMap(telemetry, name) {
    ...
    if (marker) {
        ...
        const slideDuration = status === 'running' ? 2000 : 1500;
        slideMarker(marker, latlng, slideDuration);
    ...
    const volt = (telemetry.voltage !== undefined && telemetry.voltage !== null) ? parseFloat(telemetry.voltage) : 12.0;
